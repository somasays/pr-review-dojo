...
from app.jobs.order_events_stream import batch_paid_counts, merge_paid_counts, start_paid_counts
...
def test_replayed_batch_does_not_double_the_counts(spark, tmp_path: Path):
    """The merge-into-existing-target branch must not double count a replayed batch."""
