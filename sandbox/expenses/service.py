...
class ClaimService:
    ...
    def decide(
        ...
        approver may not decide a claim they filed themselves, on either
        path. Repeating the same decision from the same approver returns
        the claim unchanged."""
        ...
        with unit_of_work(self.session_factory) as session:
            ...
            claim.payable_total = payable_total(approved_amounts)
