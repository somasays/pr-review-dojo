...
from sandbox.adserver.db import Campaign, get_session_factory
...
def get_campaign_service(session_factory: ServiceSessionFactory) -> CampaignService:
    return CampaignService(session_factory)
...
def create_app() -> FastAPI:
    ...
    def create_campaign(body: CampaignIn, ops: OpsEmail, service: CampaignServiceDep) -> Campaign:
        return service.create(ops, body.advertiser_email, body.name, body.daily_budget, body.cpm)
